...
export const Form = () => {
  ...
  const { isFetching, isSuccess, isError, errorMessage, redirect } =
  ...
  return (
    <form onSubmit={onSubmithandler} action='' className=' flex flex-col mt-10'>
      ...
      <button
        type='submit'
        className='mt-28 bg-blue-500 text-white px-3 py-3 rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-blue-400 cursor-pointer flex justify-center items-center'
      >
        <img
      ...
      <img
        src='/assets/loginAssets2.png'
        alt=''
        className='absolute bottom-0 left-0 hidden lg:flex'
      />
      <img
        src='/assets/loginAssets3.png'
        alt=''
        className='absolute bottom-0 left-0 hidden lg:flex'
      />
    </form>
