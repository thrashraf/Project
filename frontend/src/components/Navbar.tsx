    ...
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex">
              <div className="hidden lg:flex md:mr-6 lg:mr-16">
                <a className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:bg-purple-800 focus:bg-gray-100 focus:text-black  focus:outline-none transition duration-150 ease-in-out">
                  <span className="mr-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="icon icon-tabler icon-tabler-grid"
                ...
                <Link
                  ...
                  smooth={true}
                  spy={true}
                  className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:bg-purple-800 focus:bg-gray-100 focus:text-black  focus:outline-none transition duration-150 ease-in-out"
                >
                  <span className="mr-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="hidden lg:flex items-center">
                <div className="relative md:mr-6 my-2">
                  {user ? (
                    ...
                    <button className="focus:outline-none bg-gray-100 border-gray-300 border transition duration-150 ease-in-out hover:bg-gray-300 rounded text-gray-600 px-5 py-2 text-xs" onClick={() => navigate('/login')}>
                      Login
                    </button>
                  )}
                </div>
      ...
      <nav>
        ...
        <div
          className={
            show
              ? "w-full lg:hidden h-full  z-40 fixed  transform transition duration-300 ease-in-out translate-x-0 "
              : "   w-full lg:hidden h-full absolute z-40  transform transition duration-300  ease-in-out -translate-x-full"
          }
        >
          <div
                      ...
                      <li className="text-gray-800 pt-8">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3"onClick={() => navigate('/create-report')}>
                              Reports
                            </p>
                          </div>
                        </div>
