    ...
    <Modal isShowing={isShowing} hide={hide}>
      <div className='relative bg-white rounded-lg  shadow max-w-md mx-auto top-40'>
        ...
        <div className='p-6 text-center'>
          ...
          <button
            className='text-gray-500 bg-slate-100 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10  mr-5'
            onClick={hide}
          >
            No, cancel
          </button>
